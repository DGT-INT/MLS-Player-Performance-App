...
sum(duplicated(test[, c("player_id", "team_id.x", "season_name")])) # after joining the team_id.y with team_id.x, i've gotten the duplicated down to 44
...
#now below here, the rest of the code isnt doing what i want it to do
