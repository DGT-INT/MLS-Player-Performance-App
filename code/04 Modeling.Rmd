...
RMSE(preds_rf, test_data$log_salary)
MAE(preds_rf, test_data$log_salary)
R2(preds_rf, test_data$log_salary)
```

I need to comeback and tune the RF but it already appears to have improvement compared to baseline.
